...
def main():
    ...
    parser.add_argument('-I', '--indir', required = True, help = 'provide path to folder containing all aligned hieraarchies in separate folders')
    parser.add_argument('-N', '--norm', required = True, help = 'specify desired normalization. Options: none for no normalization, std for ordinary normalization, cheb for chebyshev normalization.')
    parser.add_argument('-A', '--alpha', required = True, help = 'specify scaling parameter alpha, alpha = 1 indicates no scaling.')
